...
| **Google Cloud**     | "google cloud", "gcp", "bigquery", "cloud run" | `backend-specialist` + `devops-engineer`   | ✅ YES       |
| **Gemini AI**       | "gemini", "generative ai", "llm", "vertex" | `gemini-api` + `backend-specialist`        | ✅ YES       |
...
| **Gemini AI**   | gemini, vertex, generative, llm            | `gemini-api`            |
| **Google Cloud**| gcp, google cloud, bigquery, gke           | `backend-specialist`    |
